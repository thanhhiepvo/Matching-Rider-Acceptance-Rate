...
SHAP tính cho 8.609 đơn post-dispatch (cùng subset với FAIR #1 ở mục 2).

### A.1 · Beeswarm SHAP — 14ft (gốc, model-only)

![SHAP beeswarm — 14ft gốc](img/part2shap_14ft_beeswarm.png)

### A.2 · Beeswarm SHAP — 20ft (+FE, model-only)

![SHAP beeswarm — 20ft +FE](img/part2shap_20ft_beeswarm.png)
...
| Feature | \|SHAP\| TB — 14ft | \|SHAP\| TB — 20ft | Feature mới (FE)? |
|---|---|---|---|
| is_post_dispatch | 0,9616 | 0,9561 | |
| cust_orders_30d | 0,4426 | 0,3673 | |
| **pickup_distance_km** | 0,0000 | **0,2483** | ✅ |
| vertical_name | 0,2185 | 0,2238 | |
| cust_cancel_rate_30d | 0,2553 | 0,2051 | |
| eta_seconds | 0,3472 | 0,1752 | |
| re_dispatch_counts | 0,1063 | 0,1228 | |
| **payment_method** | 0,0000 | **0,1167** | ✅ |
| trip_distance_km | 0,1132 | 0,1064 | |
| fee_per_km | 0,0632 | 0,0702 | |
| hour_of_day | 0,0827 | 0,0692 | |
| **cust_completion_rate_30d** | 0,0000 | 0,0454 | ✅ |
| surge_multiplier | 0,0442 | 0,0425 | |
| **dist_center_km** | 0,0000 | 0,0392 | ✅ |
| **dist_hotspot_km** | 0,0000 | 0,0239 | ✅ |
| total_fee | 0,0248 | 0,0204 | |
| **dist_airport_km** | 0,0000 | 0,0191 | ✅ |
| travel_mode | 0,0052 | 0,0048 | |
| is_weekend | 0,0038 | 0,0037 | |
| is_schedule_order | 0,0030 | 0,0010 | |

## B. Rule + Model — SHAP 13ft (gốc) vs 19ft (+FE = Baseline hiện tại)

### B.1 · Beeswarm SHAP — 13ft (gốc, rule + model)

![SHAP beeswarm — 13ft gốc](img/part2shap_13ft_beeswarm.png)

### B.2 · Beeswarm SHAP — 19ft (+FE, rule + model = Baseline hiện tại)

![SHAP beeswarm — 19ft +FE](img/part2shap_19ft_beeswarm.png)
...
| Feature | \|SHAP\| TB — 13ft | \|SHAP\| TB — 19ft | Feature mới (FE)? |
|---|---|---|---|
| cust_orders_30d | 0,4344 | 0,3886 | |
| **pickup_distance_km** | 0,0000 | **0,2426** | ✅ |
| vertical_name | 0,2360 | 0,2368 | |
| cust_cancel_rate_30d | 0,2637 | 0,2033 | |
| eta_seconds | 0,3519 | 0,1770 | |
| re_dispatch_counts | 0,1208 | 0,1295 | |
| trip_distance_km | 0,1192 | 0,1159 | |
| **payment_method** | 0,0000 | **0,1153** | ✅ |
| hour_of_day | 0,0867 | 0,0758 | |
| fee_per_km | 0,0600 | 0,0727 | |
| **cust_completion_rate_30d** | 0,0000 | 0,0507 | ✅ |
| surge_multiplier | 0,0459 | 0,0440 | |
| **dist_center_km** | 0,0000 | 0,0404 | ✅ |
| **dist_hotspot_km** | 0,0000 | 0,0271 | ✅ |
| **dist_airport_km** | 0,0000 | 0,0253 | ✅ |
| total_fee | 0,0276 | 0,0233 | |
| travel_mode | 0,0041 | 0,0058 | |
| is_weekend | 0,0054 | 0,0043 | |
| is_schedule_order | 0,0035 | 0,0025 | |
...
Xếp hạng 6 feature FE theo |SHAP| tuyệt đối:
